...
MODEL({
  ...
  templates: [
    ...
    },
    {
      ...
      template: function() {/*
        <div id="{{{this.id}}}-controls" class="controls">
    ...
    },
    {
      ...
      template: function() {/*
        <div id="{{{this.id}}}-tos-overlay"
             class="full trim abs abs-full lightbox-overlay {{{this.visible ? '' : 'hide'}}}">
        </div>
        <div id="{{{this.id}}}-tos"
             class="full trim abs abs-full flex-container column center {{{this.visible ? '' : 'hide'}}}">
    ...
    },
    {
      ...
      template: function() {/*
        ...
        <div id="{{{this.id}}}-lightbox"
          ...
          <div class="flex-grow flex-shrink flex-container row center">
            <div id="{{{this.id}}}"
                 class="flex-grow flex-shrink flex-container column center lightbox">
              {{{this.subViews}}}
            </div>
          </div>
        </div>
